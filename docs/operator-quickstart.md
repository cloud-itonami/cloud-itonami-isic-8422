# Operator Quickstart — Defence Procurement and Logistics Administration

Shortest path from clone to a verified local dry-run for **ISIC 8422** (`cloud-itonami-isic-8422`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8422.git
cd cloud-itonami-isic-8422
```
...
- Blueprint governor key: `defence-procurement-governor`
- Likely source path: `defence.governor.cljc`
